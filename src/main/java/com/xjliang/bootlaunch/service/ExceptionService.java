...
import com.xjliang.bootlaunch.config.exception.CustomException;
import com.xjliang.bootlaunch.config.exception.CustomExceptionType;
    ...
    public void systemBizError() throws CustomException {
        try {
            ...
            throw new CustomException(CustomExceptionType.SYSTEM_ERROR,
                "在XXX业务，myBiz() 方法内，出现ClassNotFoundException");
        }
    }
